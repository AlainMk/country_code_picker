/// [Countries] has a static method [countries] that returns list of Map for most country around the world.
class Countries {
  /// Get countries list
  static List<Map<String, dynamic>> get countries => _countryList;
